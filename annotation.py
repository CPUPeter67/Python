...
image_path = 'Anothermustang.avif' # User-provided image path
...
# Step 2: Draw two rectangles around intersecting regions
...
# Recatngle 2: Bottom-right corner
rect2_width, rect2_height = 200, 150
top_left2 = (width - rect2_width - 20, height - rect2_height - 20) # Fixed 20 pixels padding
...
cv2.circle(image_rgb, (center1_x, center1_y), 10, (0, 255, 0), -1) # Filled green circle
cv2.circle(image_rgb, (center2_x, center2_y), 10, (0, 0, 225), -1) # Filled red circle
